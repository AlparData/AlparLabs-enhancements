...
// PROTECCIÓN: Usamos ?. y || '' para evitar errores si connector o partner son undefined
...
const chatroomCrmLeadTab={get tabCrmLeadFormProps(){return{viewTitle:_t('CRM'),viewResId:this.props?.selectedConversation?.lead?.id,selectedConversation:this.props?.selectedConversation,searchButton:true,}},get titles(){
// PROTECCIÓN: Aseguramos que super.titles exista
const out=super.titles || {}
