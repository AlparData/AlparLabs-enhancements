...
AiInterfaceForm.props = { ...ChatroomActionTab.props };
AiInterfaceForm.defaultProps = { ...ChatroomActionTab.defaultProps };

patch(AiInterfaceForm.props, {
    viewModel: { type: String, optional: true },
    viewType: { type: String, optional: true },
    viewKey: { type: String, optional: true },
});

patch(AiInterfaceForm.defaultProps, {
    viewModel: 'acrux.chat.ai.interface',
    viewType: 'form',
    viewKey: 'aiInteface_form',
});
